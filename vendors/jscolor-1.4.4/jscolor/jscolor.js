...
var jscolor = {
	...
	color : function(target, prop) {
		...
		this.pickerinputHeight = 20; // px
		this.pickerClosable = false;
		this.pickerCloseText = 'Close';
		this.pickerinputColor = 'inputText'; // px
		...
		function drawPicker(x, y) {
			...
			setBtnBorder();
			p.btn.style.color = THIS.pickerinputColor;
		...
		function getPickerDims(o) {
			var dims = [
				...
				o.pickerClosable ?
					4*o.pickerInset + 3*o.pickerFace + jscolor.images.pad[1] + o.pickerinputHeight :
